...
<h2>
    <span style="margin-right: 16px;">Orders</span>
        <div class="btn-group">
        <button class="btn btn-success" onclick="DownloadOrders()" title="Bestellingen als XML downloaden">
...
<div id="DrugsPanel">
    <table id='OrdersTable' border='1' bgcolor='white'>
        <thead>
            <tr>
                <td>Id</td>
                <td>Datum</td>
        ...
        <tbody>
         <?php
            ...
            $orders = mysqli_query($con, "SELECT * FROM `middenpolder voorrraadbeheer`.order ORDER BY id DESC");
