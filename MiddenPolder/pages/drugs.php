...
<h2>
    ...
    <div class="btn-group">
        <button class="btn btn-success" onclick="EditDrug('', 'Nieuwe medicijn toevoegen')" title="Nieuwe medicijn toevoegen">
            <span class="glyphicon glyphicon-plus"></span>
        </button>
        <button class="btn btn-success" onclick="DownloadDrugs()" title="Medicijnen als XML downloaden">
...
<div id="DrugsPanel">
    ...
    echo "<table id='DrugsTable' border='1' bgcolor='white' style='display:none;'>
                        <thead>
                            <tr>
                                <td>Id</td>
                                <td>Naam</td>
...
<div class="modal fade" id="DrugPopup">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" type="button" onclick="SaveDrug()">Opslaan</button>
            </div>
        </div>
    </div>
</div>
