...
// INSERT NEW ORDER
 $sql = "insert into `middenpolder voorrraadbeheer`.`order` (`created`, `status`) VALUES (now(), 0)";
...
foreach ($ids as $productid) {
    ...
    $sql = "insert into `middenpolder voorrraadbeheer`.`orderitem` (`orderid`, `productid`, `quantity`) 
